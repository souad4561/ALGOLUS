...
<head>
    ...
    <title>Algolus</title>
    <link href="../icon/logo0.png" rel="shortcut icon"><!-- Favicon-->
    <!-- project css file  -->
            ...
            <div class="container-xxl">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        ...
                        <form  method="POST" class="row g-1 p-3 p-md-4">
                            ...
                            <div class="alert alert-danger" role="alert">
                                <strong> <?= $ErrorMsg[] = "Entrer votre Email et Mot de passe  "; ?></strong>
                            </div>
                            ...
                            <div class="alert alert-success" role="alert">
                                    <strong> <?= $loginMsg[] = "Connecter avec succées"; ?></strong>
                            </div>
                            ...
                            <?php
                             ...
                             ?>
                                                                <div class="alert alert-danger" role="alert">
                                                                <strong> <?= $ErrorMsg[] = "vérifier votre Email ou Mot de passe"; ?></strong>
                                                            </div>
                            <?php
                            }
                        }
                ...
                ?>
                                    ...
                                    <div class="mb-2">
                                        <div class="form-label">
                                            <span class="d-flex justify-content-between align-items-center">
                                                Mot de passe
                                                <a class="text-secondary" href="auth-password-reset.php">Mot de passe oublié ?</a>
                                            </span>
                                        </div>
                                ...
                                <div class="col-12 text-center mt-4">
                                    <input  type="submit" class="btn btn-lg btn-block btn-light lift text-uppercase" name="connecter" value="connecter">
                                </div>
                                <!-- <div class="col-12 text-center mt-4">
