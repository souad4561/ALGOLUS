    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li><a class="m-link active" href="contact.php"><i class="icofont-users-alt-5"></i> <span>Contact</span></a></li>
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 col-md-12 flex-column">
                                    ...
                                    <tbody>
                                       <?php while ($row =$q-> fetch()): ?>
                                         <tr>
                                            ...
                                            <td>
                                                <?php echo htmlspecialchars($row['id_contact']) ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                            <?php echo htmlspecialchars($row['sujet']) ?>
                                            </td>
                                            <td>
                                            <?php echo htmlspecialchars($row['msg']) ?>
                                             ...
                                             <td>
                                                 <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                     <button type="button" href="#showproject_<?= $row['id_contact'] ?>" class="btn btn-outline-secondary"  data-bs-toggle="modal" data-bs-target="#showproject_<?= $row['id_contact'] ?>"><i class="icofont-eye text-success"></i></button>
                                                     <button type="button" href="#deleteproject_<?= $row['id_contact'] ?>"   class="btn btn-outline-secondary deleterow" data-bs-toggle="modal" data-bs-target="#deleteproject_<?= $row['id_contact'] ?>"><i class="icofont-ui-delete text-danger"></i></button>
                                                 </div>
                                             </td>
                                         </tr>
                        ...
                        <!-- model show -->
                                        ...
                                        <div class="modal fade" id="showproject_<?= $row['id_contact'] ?>"  tabindex="-1"  aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title  fw-bold" id="editprojectLabel"> affichage des informations</h5>
                                                ...
                                                <form action="" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3"> 
                                                                ...
                                                                <input type="text" class="form-control" name="id_contact" value="<?= $row['id_contact']  ?>"disabled>

                                                                <label for="exampleFormControlInput78" class="form-label">Nom</label>                       
                                                                <input type="text" class="form-control" name="nom" value=" <?= $row['nom'] ?>" disabled>

                                                                <label for="exampleFormControlInput78" class="form-label">Email</label>                       
                                                                <input type="text" class="form-control" name="" value=" <?= $row['email'] ?>" disabled>

                                                                <label for="exampleFormControlInput78" class="form-label">Téléphone</label>                       
                                                                <input type="text" class="form-control" name="tele" value=" <?= $row['telephone'] ?>" disabled>
                                                                
                                                                <label for="exampleFormControlInput78" class="form-label">Sujet</label>                       
                                                                <input type="text" class="form-control" name="sujet" value=" <?= $row['sujet'] ?>" disabled>
                                                                

                                                                <label for="exampleFormControlInput78" class="form-label">Message</label>                       
                                                                <textarea name="msg"  class="form-control"  name="msg" rows="5"  disabled><?= $row['msg'] ?></textarea>
              ...
              <!-- Modal  Delete Folder/ File-->
                                ...
                                <div class="modal fade" id="deleteproject_<?= $row['id_contact'] ?>" tabindex="-1"  aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-md ">
                                    <div class="modal-content">
                                    ...
                                    <form action="contact.php" method="post">
                                        ...
                                        <div class="modal-body justify-content-center flex-column d-flex">
                                            ...
                                            <input type="hidden" class="form-control" name="id_contact" value="<?= $row['id_contact']  ?>">
...
try {
    ...
    { 
        ...
        // echo a message to say the delete succeeded
                              ...
                              ?> 
			  <div class="alert alert-danger" role="alert">				  
        <?php echo $stmt->rowCount() . " records delete successfully"; ?>
    </div>
