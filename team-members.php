...
<body>
   ...
   <!-- header -->
    ...
    <div class="flat-team-members team-members-style1">
        <div class="container">
            <div class="row">
                    ...
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/01.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Lindsay Andrews</a></div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/02.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Gene Richardson</a></div>
                            <div class="role">Product Manager</div>
                            <ul class="social-links">
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#" class="active"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/03.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Blanca Roberts</a></div>
                            <div class="role">Product Manager</div>
                            <ul class="social-links">
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#" class="active"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/04.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Kristine Carpenter</a></div>
                            <div class="role">Product Manager</div>
                            <ul class="social-links">
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#" class="active"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/05.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Lindsay Andrews</a></div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/06.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Gene Richardson</a></div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/07.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Blanca Roberts</a></div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-members">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="images/team-members/08.png" alt="images">
                            </div>
                        </div>
                        <div class="content">
                            <div class="name"><a href="#">Kristine Carpenter</a></div>
    ...
    <div class="flat-team-manager">
        <div class="container">
            <div class="title-section text-center">
                <p class="sub-heading color-one">Team Manager</p>
                <h2 class="flat-title">Meet our awesome<br> team manager</h2>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-manager hv-link-custom">
                        ...
                        <div class="content">
                            <h3 class="name"><a href="#">Lindsay Andrews</a></h3>
                            <div class="role">Product Manager</div>
                        </div>
                        <div class="ellipse-color"></div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-manager hv-link-custom">
                        ...
                        <div class="content">
                            <h3 class="name"><a href="#">Gene Richardson</a></h3>
                            <div class="role">Product Manager</div>
                        </div>
                        <div class="ellipse-color"></div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-manager hv-link-custom">
                        ...
                        <div class="content">
                            <h3 class="name"><a href="#">Blanca Roberts</a></h3>
                            <div class="role">Product Manager</div>
                        </div>
                        <div class="ellipse-color"></div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="team-manager hv-link-custom">
                        ...
                        <div class="content">
                            <h3 class="name"><a href="#">Kristine Carpenter</a></h3>
                            <div class="role">Product Manager</div>
                        </div>
                        <div class="ellipse-color"></div>
                    </div>
