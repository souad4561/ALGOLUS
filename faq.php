...
<body>
        ...
        <div class="container">
            <div class="flex-header">
                <div id="logo" class="logo">
                    <a href="index.php" title="Logo"><img src="images/logo/logo01.png" alt="images" data-width="115" data-height="50" data-retina="images/logo/logo01@2x.png"></a>
                </div>
                            ...
                            <ul class="menu">
                                <li><a href="#">Home</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="home3.php">Home One Page</a></li>
                                    </ul>
                                </li>
                                <li><a href="#">Services</a>
                                    <ul class="sub-menu">
                                        <li><a href="services.php">Services</a></li>
                                        <li><a href="services-details-sidebar-left.php">Services details 1</a></li>
                                        <li><a href="services-details-sidebar-right.php">Services details 2</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="lang-user">
                       <div class="language-name">
                        ...
                        <div class="user">
                            ...
                            <a href="#" class="icon"><span class="icon-user"></span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="flat-question">
                        <div class="accordion">
                            ...
                            <div class="accordion-toggle">
                                <div class="toggle-title">05. How much does it cost?</div>
                                <div class="toggle-content">
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident sunt deserunt.
                                </div>
                                <div class="rectangle-1"></div>
                            ...
                            <div class="accordion-toggle">
                                <div class="toggle-title">06. How much does it cost?</div>
                                <div class="toggle-content">
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident sunt deserunt.
                                </div>
                                <div class="rectangle-1"></div>
                            ...
                            <div class="accordion-toggle">
                                <div class="toggle-title">07. How much does it cost?</div>
                                <div class="toggle-content">
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident sunt deserunt.
                                </div>
                                <div class="rectangle-1"></div>
    ...
    <div class="contact-section contact-transform contact-style3 mg-change-66">
        <div class="container">
            <div class="contact-inside d-lg-flex">
                <div class="col-left">
                    <div class="contact-us question-style">
                        <div class="title-section">
                            <h2 class="flat-title">Have any question in your mind?</h2>
                        </div>
                        <div class="question-images">
                            <img src="images/faq/02.png" alt="images">
                        </div>
                    </div>
                </div>
                <div class="col-right">
                    <form id="contactform" action="./contact/contact-process.php" method="post" class="form-contact form-submit">
                        ...
                        <div class="text-wrap d-sm-flex clearfix">
                            <div class="w-left">
                                <input type="text" name="subject" id="subject" value="" class="subject" placeholder="Subject:">
                            </div>
                            <div class="w-right">
                                <input type="text" name="phone" id="phone" value="" class="phone" placeholder="Phone:">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-12">
                            <div class="widget widget-subscribe">
                                ...
                                <form action="#" class="subscribe-form btn-linear linear-color-one">
                                    <input type="email" placeholder="suka24@gmail.com">
                                    <button class="btn-join-now hv-linear">join now</button>
                                </form>
                                <p class="description">*Subscribe today for update.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-4 col-12 mg-widget pd-footer-69">
                            <h3 class="widget widget-title">Support</h3>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-4 col-12 mg-widget">
                            ...
                            <ul class="widget-social-media">
                                ...
                                <li><a href="#" class="active"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
            ...
            <div class="container">
                <div class="bottom-wrap">
                    <div class="bottom-inside d-md-flex justify-content-md-between align-items-center">
                        ...
                        <div class="address">452 Center Dr. Littleton, CO 80123</div>
                        <div class="logo-footer">
                            <a href="index.php"><img src="images/logo/logo03.png" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
